...
public class PromethianBullets : PassiveItem
{
	...
	private sealed class _003CChangeProjectileDamage_003Ed__3 : IEnumerator<object>, IDisposable, IEnumerator
	{
		...
		public PromethianBullets _003C_003E4__this;
	...
	public static void Init()
	{
		...
		PickupObject val = ItemSetup.NewItem<PromethianBullets>("Promethean Bullets", "Forethought", "Deals 50% more damage to enemies who have more than half their health.\n\nCreated by the mighty titan bullet Prometheus.", "promethianbullets_icon", assetbundle: true);
