...
public class DARCCannon : GunBehaviour
{
	...
	public static void Add()
	{
		...
		Gun val = Databases.Items.NewGun("DARC Cannon", "darccannon");
		Game.Items.Rename("outdated_gun_mods:darc_cannon", "nn:arc_cannon+darc_cannon");
		((Component)val).gameObject.AddComponent<DARCCannon>();
		...
		val.SetGunSprites("darccannon", 8, noAmmonomicon: true);
		...
		List<string> list = new List<string> { "NevernamedsItems/Resources/TrailSprites/bigdarctrail_mid_001", "NevernamedsItems/Resources/TrailSprites/bigdarctrail_mid_002", "NevernamedsItems/Resources/TrailSprites/bigdarctrail_mid_003" };
		TrailAPI.AddTrailToProjectile(val2, "NevernamedsItems/Resources/TrailSprites/bigdarctrail_mid_001", new Vector2(8f, 7f), new Vector2(1f, 1f), list, 20, list, 20, -1f, 0.0001f, -1f, true, true);
		...
		PickupObject byId4 = PickupObjectDatabase.GetById(DARCPistol.ID);
		...
		val5.numberToSpawnOnCollison = 7;
