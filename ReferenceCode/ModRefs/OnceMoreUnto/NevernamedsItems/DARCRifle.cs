...
public class DARCRifle : GunBehaviour
{
	...
	public static void Add()
	{
		...
		Gun val = Databases.Items.NewGun("DARC Rifle", "darcrifle");
		Game.Items.Rename("outdated_gun_mods:darc_rifle", "nn:arc_rifle+darc_rifle");
		((Component)val).gameObject.AddComponent<DARCRifle>();
		...
		val.SetGunSprites("darcrifle", 8, noAmmonomicon: true);
		...
		component.baseData.damage = 31.2f;
