...
public class ARCShotgun : AdvancedGunBehavior
{
	...
	public static void Add()
	{
		...
		Gun val = Databases.Items.NewGun("ARC Shotgun", "arcshotgun");
		Game.Items.Rename("outdated_gun_mods:arc_shotgun", "nn:arc_shotgun");
		ARCShotgun aRCShotgun = ((Component)val).gameObject.AddComponent<ARCShotgun>();
		...
		for (int i = 0; i < 6; i++)
		{
			PickupObject byId3 = PickupObjectDatabase.GetById(ARCPistol.ID);
