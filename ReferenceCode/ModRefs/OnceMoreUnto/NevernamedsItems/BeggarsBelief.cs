...
internal class BeggarsBelief : PassiveItem
{
	...
	public static void Init()
	{
		...
		PickupObject val = ItemSetup.NewItem<BeggarsBelief>("Beggars Belief", "Another Mans Treasure", "Guarantees an extra special bonus room every chamber.\n\nYou made an old bullet very happy. Good job.", "beggarsbelief_icon", assetbundle: true);
		val.quality = (ItemQuality)3;
		ID = val.PickupObjectId;
		val.SetupUnlockOnCustomStat(CustomTrackedStats.BEGGAR_TOTAL_DONATIONS, 5114f, (PrerequisiteOperation)2);
	}
	...
	public static void InitRooms()
	{
		...
		val2.annotation = "BeggarsBeliefRoom";
		...
		val2.roomTable = null;
		val2.exactRoom = RoomFactory.BuildNewRoomFromResource("NevernamedsItems/Content/NPCs/Rooms/BeggarsBeliefRoom.newroom", (Assembly)null).room;
		...
		((Object)val).name = "BeggarsBeliefRooms";
	...
	{
		PassiveItem.IncrementFlag(player, typeof(BeggarsBelief));
		((PassiveItem)this).Pickup(player);
	}

	public override void DisableEffect(PlayerController player)
	{
		PassiveItem.DecrementFlag(player, typeof(BeggarsBelief));
