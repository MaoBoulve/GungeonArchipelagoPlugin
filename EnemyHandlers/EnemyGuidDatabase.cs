...
namespace ArchiGungeon.EnemyHandlers
{
	...
	public class EnemyGuidDatabase
	{
		...
		private static Dictionary<string, string> NormalEnemyList { get; } = new Dictionary<string, string>
		{
			{ "bullet_kin", "01972dee89fc4404a5c408d50007dad5" },
			{ "ak47_bullet_kin", "db35531e66ce41cbb81d507a34366dfe" },
			{ "bandana_bullet_kin", "88b6b6a93d4b4234a67844ef4728382c" },
		...
		private static Dictionary<string, string> HardEnemiesList { get; } = new Dictionary<string, string>
		{
			{ "bullet_kin", "01972dee89fc4404a5c408d50007dad5" },
			{ "ak47_bullet_kin", "db35531e66ce41cbb81d507a34366dfe" },
			{ "bandana_bullet_kin", "88b6b6a93d4b4234a67844ef4728382c" },
		...
		private static Dictionary<string, string> BossEnemyList { get; } = new Dictionary<string, string>
		{
		...
		public static Dictionary<string, string> GetShuffledGUIDList(EnemyShuffleCategories shuffledList, int seed)
        {
			...
			List<string> baseEnemyList;
			List<string> shuffledEnemyList;
			Dictionary<string, string> shuffledGUIDsMap = new();

			switch(shuffledList)
            {
				case EnemyShuffleCategories.NormalDifficultyShuffle:
					{
						baseEnemyList = new List<string>(NormalEnemyList.Values);
						shuffledEnemyList = new List<string>(NormalEnemyList.Values);
						break;
					}

				case EnemyShuffleCategories.HardDifficultyShuffle:
					{
						baseEnemyList = new List<string>(HardEnemiesList.Values);
						shuffledEnemyList = new List<string>(HardEnemiesList.Values);
						break;
					}

				case EnemyShuffleCategories.BossShuffle:
                    {
						baseEnemyList = new List<string>(BossEnemyList.Values);
						shuffledEnemyList = new List<string>(BossEnemyList.Values);
						break;
                    }
				default:
					return null;
			...
			{
				shuffledGUIDsMap.Add(baseEnemyList[i], shuffledEnemyList[i]);
				i++;
			}

			return shuffledGUIDsMap;
        }
